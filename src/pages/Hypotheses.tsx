  ...
  return (
    <section className="rounded-xl border border-line bg-surface p-4">
      ...
      <p className="text-[12px] text-ink-muted leading-relaxed mb-3">
        Обложка меняется каждый час. Раунд — {c.round_days ?? 3} дня: нынешняя
        обложка против {c.per_round ?? 2} кандидатов, и за раунд каждый участник
        стоит в каждом часе окна ровно раз, поэтому время суток не мешает.
